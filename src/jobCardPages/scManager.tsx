...
import SeniorContentM from '../jobRolepages/sCM';
...
const Senior: React.FC = () => {
  ...
  return (
    <div>
      {manager.map((card, index) => (
        <div key={index} className="main rounded-md border border-zinc-300 shadow-lg hover:border-blue-500 hover:translate-y-1 hover:scale-103 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 mt-2 lg:p-0 p-5">
