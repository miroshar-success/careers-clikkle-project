...
const Aws: React.FC = () => {
    ...
    const handleApply = () => {
        navigate("/apply-for-job", { state: { role: "AWS Platform Engineer" } });
    }
    ...
    return (
        <div className="flex flex-col h-screen mx-8 md:mx-16 lg:mx-24 xl:mx-32 gap-4 dark:text-zinc-500">
            ...
            <h1 className="text-2xl dark:text-zinc-300 font-bold mt-4">AWS Platform Engineer</h1>
            ...
            <section className="mb-8">
                <h2 className="text-xl dark:text-zinc-300 mb-2">Required Qualifications</h2>
                <ul className="list-disc pl-4 text-sm md:text-base">
