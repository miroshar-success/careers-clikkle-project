...
const MManager: React.FC = () => {

    const navigate = useNavigate();

    const handleApply = () => {
        navigate("/apply-for-job", { state: { role: "Marketing Manager" } });
    }
    ...
    return (
        <div className="flex flex-col h-screen mx-8 md:mx-16 lg:mx-24 xl:mx-32 gap-4 dark:text-zinc-500">
            ...
            <h1 className="text-2xl dark:text-zinc-200 font-bold mt-4">Marketing Manager</h1>
            <div className="flex flex-col dark:text-zinc-400 md:flex-row gap-8 mt-5">
                <div className="flex items-center"><FontAwesomeIcon icon={faWallet} /> <span className="ml-2">29,000 Cad</span></div>
            ...
            <section className="mb-8">
                ...
                <p className="text-sm md:text-base">As the Digital Marketing Manager you will play a key role in driving the company's eCommerce business, and responsible for the development and execution of various campaigns and projects </p>
            </section>
            <section className="mb-8">
